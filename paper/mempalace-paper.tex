...
Closet  & Pointer index (v3.3.0+) & Compact lookup layer        & Shelf in a room$^{*}$ \\
...
Mem0 (pre-Apr.\ 2026) & $\sim$49\% & LLM fact extraction & LLM & \$19--249/mo \\
Mem0 (token-efficient) & 93.4\%   & Single-pass hierarchical & LLM & \$19--249/mo \\
